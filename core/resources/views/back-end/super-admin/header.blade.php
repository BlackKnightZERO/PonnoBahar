    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown dropdown-user">
          <a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
            <!-- <img src="{{ asset('') }}{{ Auth::user()->profile_picture }}" class="rounded-circle mr-2" height="34" alt=""> -->
            <img src="{{ asset('').'core/public/storage/'.Auth::user()->profile_picture }}" class="rounded-circle mr-2" height="34" alt="">
            <span>{{ Auth::user()->name }}</span>
          </a>
          <div class="dropdown-menu dropdown-menu-right">
              <a href="{{ route('super.admin.profile') }}" class="dropdown-item"><i class="icon-user-plus"></i> My profile</a>
