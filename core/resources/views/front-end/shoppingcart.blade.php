	...
	<header class="header-v4">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="{{ $cart_badge }}">
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart" data-notify="{{ $cart_badge }}">
					<i class="zmdi zmdi-shopping-cart"></i>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<form  method="post" action="{{ route('user.updateCart') }}">
					@csrf
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
								...
								<tr class="table_row">
									...
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="numProduct[]" value="{{ $row->quantity }}">
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							...
							<button class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" type="submit">Update Cart</button>
				...
				<form action="{{ route('user.order') }}" method="post">
					...
					<input type="hidden" name="p_sub_total" value="{{ $sub_total }}">
					...
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="form-control" name="shipping_location" id="time">
											<option>Select..
											</option>
											@if($s_location)
									...
									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="address" placeholder="address" required="required">
									</div> 

									 <div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="shipping_cost" id="shipping_cost" placeholder="shipping cost" required="required">
									</div>
						...
						@if (Route::has('login'))
                    	@auth
						<!-- <a href="#" type="button" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</a> -->
						...
						@else
						<a href="{{ route('logout') }}" type="button" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Log In</a>
						@endauth
                    	@endif
					</div>
    		...
    		var total3 = '0';
    		 $.ajax({
                  ...
                  success:function(data) {
                    ...
                    total3 = parseInt(total) + parseInt(data.shipping_cost) ;
                    $('.total_cost_2').text(`$${total3}`);
                    $('#create_total_input').append(`<input type="hidden" name="total" value="${total3}"/>`);
                    $('#create_total_input').append(`<input type="hidden" name="ship_to" value="${data.name}"/>`);
                 },
                    error: function()
                   {
                   	$('#create_total_input').empty();
