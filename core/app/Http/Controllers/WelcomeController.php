...
class WelcomeController extends Controller
{
    ...
    public function index()
    {
    	...
    	return view('welcome',['categories' => $categories, 'g_settings' => $g_settings, 'w_settings' => $w_settings, 'featured'=>$featured , 'on_sale'=>$on_sale , 'top_rate'=>$top_rate, 'product_img_9' => $product_img_9, ]);
    }
}
